...
function Slider() {
  return (
    <div className=" relative h-screen w-full ">
      ...
      />
      <div className="absolute inset-0 w-full h-full bg-gradient-to-b from-[#04090cba] via-[#04090cba] to-[#003d554a]  "></div>
      <div className="absolute inset-0 w-full h-full z-10 flex flex-col justify-center items-center text-center">
        <h2 className="text-3xl md:text-5xl leading-[1.2]  font-medium w-[90%] md:w-[70%] lg:w-[50%]  text-gray-200 font-montserrat  mt-8 md:mt-20">
